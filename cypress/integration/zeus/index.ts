...
export type ValueTypes = {
	...
	["Query"]: AliasType<{
	libraries?:ValueTypes["Library"],
	library?:ValueTypes["Library"],
	authors?:ValueTypes["Author"],
author?: [{	id: string},ValueTypes["Author"]],
	books?:ValueTypes["Book"],
bookByName?: [{	name: string},ValueTypes["Book"]],
		__typename?: boolean | `@${string}`
}>;
	["CreateBookInput"]: {
	title: string,
	...
	["Mutation"]: AliasType<{
createBook?: [{	input?: ValueTypes["CreateBookInput"] | undefined | null},ValueTypes["Book"]],
		__typename?: boolean | `@${string}`
}>
  }
...
export type ModelTypes = {
	...
	name: string,
	address: string,
	books?: Array<GraphQLTypes["Book"]> | undefined
};
	["Book"]: {
		id: string,
	title: string,
	...
	["Query"]: {
		libraries?: Array<GraphQLTypes["Library"]> | undefined,
	library?: GraphQLTypes["Library"] | undefined,
	authors?: Array<GraphQLTypes["Author"]> | undefined,
	author?: GraphQLTypes["Author"] | undefined,
	books?: Array<GraphQLTypes["Book"]> | undefined,
	bookByName?: Array<GraphQLTypes["Book"] | undefined> | undefined
};
	["CreateBookInput"]: GraphQLTypes["CreateBookInput"];
	["Mutation"]: {
		createBook?: GraphQLTypes["Book"] | undefined
}
    }
